...
import { fetchMyEnglishAuctions} from "../../redux/actions/myAuctions";
import {convertToEther, convertToTime} from "../../utils/util";
import {Link} from "react-router-dom";
import {API} from "../../constans";
import {apiIPFS, apiIPFSLOCAL} from "../../constans/config";
    class MyEnglishActiveAuctions extends React.Component {
    ...
    componentDidMount() {
        ...
        this.props.fetchMyEnglishAuctions(this.props.loggedInUser.username);
    }
...
const mapDispatchToProps = (dispatch) => {
    return ({
        fetchMyEnglishAuctions: (username) => {
            dispatch(fetchMyEnglishAuctions(username))
        }
    });
};

export default connect(mapStateToProps,mapDispatchToProps)(MyEnglishActiveAuctions);
